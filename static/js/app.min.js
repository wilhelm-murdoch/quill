...
(function (angular, window) {
  ...
  disqusModule.provider('$disqus', function () {
    var TYPE_EMBED = 'embed.js';
    // general disqus embed script
    ...
    function hasScriptTagInPlace(container, scriptSrc) {
      var scripts = container.getElementsByTagName('script'), script, i;
    ...
    function addScriptTag(shortname, type) {
      var container = getScriptContainer(), scriptSrc = getScriptSrc(shortname, type);
   ...
   */
  disqusModule.directive('disqusIdentifier', [
    '$disqus',
    function ($disqus) {
      return {
        restrict: 'A',
...
var Quill = angular.module('Quill', [
    'ngResource',
    'ngRoute',
    'ngSanitize',
    'ngAnimate',
    ...
    '$http',
    '$disqus',
    function ($rootScope, $http, $disqus) {
